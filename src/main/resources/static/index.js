...
function initialize() {
    ...
    getStudents("http://studentrestapienv-env.eba-bvduesii.us-east-1.elasticbeanstalk.com/api/students");
}
...
function getOneStudent(id) {
    ...
    var url = "http://studentrestapienv-env.eba-bvduesii.us-east-1.elasticbeanstalk.com/api/students" + id;
    //make initial api call to get Student list
    var xhttpList = new XMLHttpRequest();
    var student;
...
function renderStudent(data) {
    ...
    for (var index = 0; index < json.length; index++) {
        ...
        var cardHtml = '  <div class="card bg-primary"  style="width:300px; margin:20px" id="' + json[index].id + '">'
            ...
            + '<img class="card-img-top" src=' + json[index].imagePath + ' alt="Card image" style="width:100%" height="170">'
            + '</div>'
...
function createStudent() {
    ...
    if (ok == true) {
        ...
        xhttp.open("POST", "http://studentrestapienv-env.eba-bvduesii.us-east-1.elasticbeanstalk.com/api/add/student", true);
...
function deleteStudent(id) {
    ...
    var link = "http://studentrestapienv-env.eba-bvduesii.us-east-1.elasticbeanstalk.com/api/delete/student" + id;
...
function updateStudent(id) {
    ...
    if (ok == true) {
        ...
        xhttp.open("PUT", "http://studentrestapienv-env.eba-bvduesii.us-east-1.elasticbeanstalk.com/api/update/student", true);
        xhttp.setRequestHeader('content-Type', 'application/json');
        xhttp.onreadystatechange = function () {
            if (this.readyState == 4 && this.status == 200) {
                console.log("Update success");
